...
namespace AutoCAD_2022_Plugin_Demo.EntityDemo
{
    ...
    {
        // 扩展double实现弧度转换角度
        public static double AngleToDegree(this double angle) { return angle * 180 / Math.PI; }
        ...
        // 扩展double实现角度转换弧度
        public static double DegreeToAngle(this double degree) { return degree * Math.PI / 180; }
